class Menu {
  ...
  final Map _menuData = {
    ...
    'Café (Cold)': [
      ...
      {'ID': 122, 'name': 'Blended Orange/ pineapple/Lemonade', 'price': 150},
    ],
    'Shakes': [
    ...
    'Imported Spirits (60 ml)': [
      {'ID': 166, 'name': 'Grey Goose', 'price': 895},
      {
        'ID': 167,
        'name': 'Gordon’s/ Smirnoff/ Vodka/Beefeater/Absolut',
        'price': 695
      },
      {
        'ID': 168,
    ...
    'Regular Scotch Whisky (60ml)': [
      {'ID': 170, 'name': 'J&B/ Vat 69/ Ballantines/ Jim Beam', 'price': 695},
    ],
    'PREMIUM SCOTCH WHISKY (12 years old) (60ml)': [
      {'ID': 171, 'name': 'Chivas Regal (18 years)', 'price': 1465},
      {'ID': 172, 'name': 'Jack Daniels/Singleton (12 years)', 'price': 685},
